 ...
 */
final class Version20230206160511 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE inscription (outing_id INT NOT NULL, user_id INT NOT NULL, INDEX IDX_5E90F6D6AF4C7531 (outing_id), INDEX IDX_5E90F6D6A76ED395 (user_id), PRIMARY KEY(outing_id, user_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE outing CHANGE updated_at updated_at DATETIME DEFAULT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE outing CHANGE updated_at updated_at DATETIME NOT NULL');
    }
}
